...
module.exports = __webpack_require__(/*! H:\Documentos\Curso web api .net core\dotnetcore\ProAgil-App\src\main.ts */"zUnb");
...
EventosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventosComponent, selectors: [["app-eventos"]], decls: 5, vars: 0, consts: [["action", ""], [1, "form-group", "mb-2"], ["type", "text", 1, "from-control", "mr-2"], [1, "btn", "btn-outline-success"]], template: function EventosComponent_Template(rf, ctx) { if (rf & 1) {
